...
export default function Navigation() {
    ...
    return (
        <nav className="bg-white text-gray-900 shadow-sm px-4 md:px-6 py-3 md:py-4 flex justify-between items-center z-50 relative border-b border-gray-100 font-display">
            ...
            {menuOpen && (
                <div className="md:hidden absolute top-full left-0 right-0 bg-white border-b-4 border-gray-900 shadow-[0_8px_0_0_#111827] z-50 flex flex-col font-extrabold text-lg">
