    ...
    return (
        ...
        >
            ...
            <div className="flex md:hidden h-[100vh] flex-col items-center justify-center gap-4 px-6">
                ...
                {/* Two small pill stickers side by side */}
                ...
                {/* Progress bar */}
                <div className="shutter-sticker mt-2 w-56 flex flex-col gap-2">
                    <div className="rounded-full bg-slate-900/20 border-2 border-slate-900 overflow-hidden p-[2px] shadow-inner h-5 bg-white">
                        <div id="shutter-progress" className="h-full rounded-full bg-[#2bee6c] border-r-2 border-slate-900" style={{ width: '0%' }} />
                    </div>
                    <p className="text-center font-display font-bold text-slate-900 text-xs tracking-widest bg-white/50 rounded-full px-2 py-1 border-2 border-slate-900">
                        BLOOMING...
                    </p>
                </div>
            </div>
